<?php
	...
	if( $type ) {
		if( $type == 'van' || $type == 'new-van' ) {
			$search_args['meta_query'][] = array( 
				'key' => 'Bodytype',
				'value' => array( 'VAN', 'van', 'Van', 'Pick up', 'Pick Up', 'PICK UP', 'pickup', 'pick-up', 'Panel Van', 'Panel van', 'panel van' ),
				'compare' => 'IN'
			);
			/*$search_args['meta_query'][] = array( 
				'key' => 'Bodytype',
	...
	<?php
		...
		. '</div>';
		echo '<ul id="car-listings" class="car-listings" style="width:66%;float:right;">';
...
?>
	<pre style="display:none">
		...
		SEARCH ARGS: <?php print_r( $search_args ); ?>
	</pre>
	<h2>We're sorry...</h2>
