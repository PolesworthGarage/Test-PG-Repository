...
class SContAdminClass {
    ...
    private function __construct() {
        ...
        add_action('admin_menu', array($this, 'SContSubmenu'));
        ...
        add_action('admin_menu', array($this, 'SCuninstallPlugin'));
    ...
    public function SContSubmenu() {
        ...
        add_submenu_page('edit.php?post_type=contact', 'Featured plugins', 'Featured plugins', 'manage_options', 'cont_featured_plugins', array($this,'displayFeaturedPlugins'));
        add_submenu_page('edit.php?post_type=contact', 'Featured themes', 'Featured themes', 'manage_options', 'cont_featured_themes', array($this,'displayFeaturedThemes'));
    ...
    public function includeAdminStyle() {
        ...
        wp_enqueue_style('cont-featured_plugins', plugins_url('css/featured_plugins.css', __FILE__), 1, $this->version);
        wp_enqueue_style('cont-featured_themes', plugins_url('css/featured_themes.css', __FILE__), 1, $this->version);
            ...
            <div style="width: 100%; text-align: right;clear:both;">
                <a href="https://web-dorado.com/products/wordpress-team-wd.html" target="_blank"
                   style="text-decoration:none;box-shadow: none;">
                    <img src="<?php echo plugins_url('/images/pro.png', __FILE__); ?>" border="0"
                         alt="https://web-dorado.com/" width="215">
                </a>
                <div>
                    <a class="team_user_manual" target="_blank" href="https://web-dorado.com/wordpress-team-wd/installing.html">User Manual<span></span></a>
                </div>
            </div>
            <?php
        }
    ...
    public function registerContOptions() {
        ...
        add_option("cont_active_theme" , 23);
    }
    ...
    public function displayFeaturedThemes() {
        include_once('views/admin/SCViewFeaturedThemes.php' );
    }
    ...
    public function displayFeaturedPlugins() {
        include_once('views/admin/SCViewFeaturedPlugins.php' );
    }
