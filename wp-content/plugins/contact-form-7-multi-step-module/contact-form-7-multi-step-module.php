 ...
 */
function send_mail_for_form( $cf7_posted_data_2 ) {
    $wpcf7 = WPCF7_ContactForm::get_current();
    if ( $wpcf7->id() == 120602 ) {
            $wpcf7->skip_mail = false;
    }
    return $cf7_posted_data_2;
}
add_filter('wpcf7_posted_data_2', 'send_mail_for_form');

function send_mail_for_form_2( $cf7_posted_data ) {
    $wpcf7 = WPCF7_ContactForm::get_current();
    if ( $wpcf7->id() == 120602 ) {
            $wpcf7->skip_mail = false;
    }
...
add_filter('wpcf7_posted_data', 'send_mail_for_form_2');
